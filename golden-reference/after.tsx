...
// --- Select option constants for useProgressiveFields ---
...
const PROJECT_REFERENCE_OPTIONS = [
  { value: 'yes', label: 'Yes' },
  { value: 'no', label: 'No' },
];
...
const ACTIVITY_OPTIONS = [
  ...
  { value: 'Manufacturing', label: 'Product Manufacturing' },
];

const BUSINESS_NATIONALITY_OPTIONS = [
...
export default function PinRegistrationApplication() {
      ...
      fields: [
        {
          ...
          bind: [hasProjectReference, (v) => setHasProjectReference(v as 'yes' | 'no' | null)],
        },
      ],
    },
      ...
      fields: [
        {
          ...
          type: 'text',
          required: true,
          bind: [projectName, (v) => setProjectName(v as string)],
        },
        {
          id: 'project.address',
          label: 'Project address',
          type: 'text',
          bind: [projectAddress, (v) => setProjectAddress(v as string)],
        },
        {
          id: 'project.county',
          ...
          bind: [projectCounty, (v) => setProjectCounty(v as string)],
        },
        {
          id: 'project.subCounty',
          label: 'Project sub-county',
          type: 'select',
          required: true,
          options: SUB_COUNTY_OPTIONS,
          bind: [projectSubCounty, (v) => setProjectSubCounty(v as string)],
        },
        {
          id: 'project.town',
          label: 'Project town',
          type: 'text',
          bind: [projectTown, (v) => setProjectTown(v as string)],
        },
        {
          id: 'project.sector',
          ...
          bind: [projectSector, (v) => setProjectSector(v as string)],
        },
        {
          id: 'project.activity',
          ...
          bind: [projectActivity, (v) => setProjectActivity(v as string)],
        },
        {
          ...
          type: 'text',
          required: true,
          bind: [projectDescription, (v) => setProjectDescription(v as string)],
        },
        {
          id: 'project.nationality',
          label: 'Business nationality',
          type: 'select',
          required: true,
          options: BUSINESS_NATIONALITY_OPTIONS,
          bind: [projectNationality, (v) => setProjectNationality(v as string)],
        },
        {
          id: 'project.amount',
          ...
          type: 'text',
          required: true,
          bind: [projectAmount, (v) => setProjectAmount(v as string)],
        },
        {
          id: 'project.localStaff',
          label: 'Local staff count',
          type: 'text',
          bind: [projectLocalStaff, (v) => setProjectLocalStaff(v as string)],
        },
        {
          id: 'project.foreignStaff',
          label: 'Foreign staff count',
          type: 'text',
          bind: [projectForeignStaff, (v) => setProjectForeignStaff(v as string)],
        },
      ],
    },
  ...
  useRegisterUIAction(
    ...
    () => {
      ...
      return 'Director form closed. Any unsaved changes have been discarded.';
    },
    { category: 'pin-registration' }
  );
  useRegisterUIAction(
